...
/* O(N * Log(N)) - Transforms the almost convex polygon into a sorted (counter-clockwise) almost convex polygon such that no other point
is collinear with the first edge or the last edge. */
template <class T>

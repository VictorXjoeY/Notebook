...
/* O(Log^2(N)) - Returns true if n is probably prime and returns false if it composite for sure. */
...
/* O(12 * Log^2(N)) - Deterministic Miller Rabin for 64 bit integers. Returns true if n is prime and returns false otherwise. */
